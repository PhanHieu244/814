...
public class TankController : MonoBehaviour
{
	...
	private void Update()
	{
		...
		float x = mainTextureOffset.x + Mathf.Sign(_moveSpeed) * Mathf.Lerp(0f, TrailMaterialOffsetSpeed, Mathf.Abs(_moveSpeed / MoveSpeed) + Mathf.Abs(_rotateSpeed / RotateSpeed));
