...
public class vLoadLevel : MonoBehaviour
{
	...
	private void OnTriggerEnter(Collider other)
	{
		...
		{
			GameObject gameObject = new GameObject("spawnPointFinder");
			vFindSpawnPoint vFindSpawnPoint = gameObject.AddComponent<vFindSpawnPoint>();
			vFindSpawnPoint.AlighObjetToSpawnPoint(other.gameObject, spawnPointName);
