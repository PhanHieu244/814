...
public class CameraControl
{
	...
	public bool IsPressed => Input.GetKey(keyCode);
	...
	public float Value
	{
		get
		{
			...
			case MouseCodeEnum.ScrollWheel:
				num = (0f - Input.GetAxis("Mouse ScrollWheel")) * StepSize * 100f * Time.deltaTime;
				break;
			case MouseCodeEnum.X:
				num = Input.GetAxis("Mouse X") * StepSize * 100f * Time.deltaTime;
				break;
			case MouseCodeEnum.Y:
				num = Input.GetAxis("Mouse Y") * StepSize * 100f * Time.deltaTime;
				break;
			}
			if (num == 0f && IsPressed)
			{
