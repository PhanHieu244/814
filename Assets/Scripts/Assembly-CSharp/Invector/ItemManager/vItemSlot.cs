...
{
	public class vItemSlot : MonoBehaviour, IPointerClickHandler, ISelectHandler, IDeselectHandler, ISubmitHandler, IPointerEnterHandler, IPointerExitHandler, IEventSystemHandler
	{
		public Image icon;
		...
		public virtual void SetValid(bool value)
		{
			...
			if (!(blockIcon == null))
			{
				blockIcon.color = ((!value) ? Color.white : Color.clear);
		...
		{
			if (eventData.button == PointerEventData.InputButton.Left && isValid && onSubmitSlotCallBack != null)
			{
