...
namespace Invector.CharacterController
{
	...
	public class GenericInput
	{
		...
		public bool GetButtonUp()
		{
			...
			if (inputDevice == InputDevice.Mobile)
			{
				if (CrossPlatformInputManager.GetButtonUp(buttonName))
				{
					return true;
				}
			}
		...
		public float GetAxis()
		{
			...
			if (inputDevice == InputDevice.Mobile)
			{
				return CrossPlatformInputManager.GetAxis(buttonName);
			}
		...
		public float GetAxisRaw()
		{
			...
			if (inputDevice == InputDevice.Mobile)
			{
				return CrossPlatformInputManager.GetAxisRaw(buttonName);
			}
			if (inputDevice == InputDevice.MouseKeyboard)
			{
