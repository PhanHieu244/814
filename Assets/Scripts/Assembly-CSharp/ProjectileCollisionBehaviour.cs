...
public class ProjectileCollisionBehaviour : MonoBehaviour
{
	...
	private void InitializeDefault()
	{
		...
		randomDirection3 = 0;
		frameDroped = false;
		tRoot = ((!IsRootMove) ? base.transform.parent : effectSettings.transform);
	...
	private void Update()
	{
		...
		{
			Vector3 vector = effectSettings.UseMoveVector ? forwardDirection : ((!effectSettings.IsHomingMove) ? forwardDirection : tTarget.position);
